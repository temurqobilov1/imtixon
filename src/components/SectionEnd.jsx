  ...
  return (
    <section className="max-h-[284px] mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-2">
      <div className="border border-gray-400 rounded-lg cursor-pointer hover:shadow-lg">
        <img className="rounded-t-lg" src="/f1.svg" alt="" />
        <div className="p-3">
      ...
      <div className="border border-gray-400 rounded-lg cursor-pointer hover:shadow-lg">
        <img className="rounded-t-lg" src="/f2.svg" alt="" />
        <div className="p-3">
      ...
      <div className="border border-gray-400 rounded-lg cursor-pointer hover:shadow-lg">
        <img className="rounded-t-lg" src="/f3.svg" alt="" />
        <div className="p-3">
      ...
      <div className="border border-gray-400 rounded-lg cursor-pointer hover:shadow-lg">
        <img className="rounded-t-lg" src="/f4.svg" alt="" />
        <div className="p-3">
      ...
      <div className="border border-gray-400 rounded-lg cursor-pointer hover:shadow-lg">
        <img className="rounded-t-lg" src="/f5.svg" alt="" />
        <div className="p-3">
